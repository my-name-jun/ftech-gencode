...
module.exports = {
    entry: {
        ...
        "akg_bank": "./akg/view/bank/index.js",
        "akg_information": "./akg/view/information/index.js",
        "akg_verify": "./akg/view/verify/index.js",
        "akg_notes": "./akg/view/notes/index.js",
        "akg_success": "./akg/view/success/index.js",
    },
    output: {
   ...
   ,
        ...
        new HtmlWebpackPlugin({
            filename: 'akg-bank.html',
            chunks: ['common.js', 'akg_bank'],
            template: './akg/view/bank/index.html',
            inject: true,
            hash: true
        }),
        new HtmlWebpackPlugin({
            filename: 'akg-information.html',
            chunks: ['common.js', 'akg_information'],
            template: './akg/view/information/index.html',
            inject: true,
            hash: true
        }),
        new HtmlWebpackPlugin({
            filename: 'akg-verify.html',
            chunks: ['common.js', 'akg_verify'],
            template: './akg/view/verify/index.html',
            inject: true,
            hash: true
        }),
        new HtmlWebpackPlugin({
            filename: 'akg-notes.html',
            chunks: ['common.js', 'akg_notes'],
            template: './akg/view/notes/index.html',
            inject: true,
            hash: true
        }),new HtmlWebpackPlugin({
            filename: 'akg-success.html',
            chunks: ['common.js', 'akg_success'],
